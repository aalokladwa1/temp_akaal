...
@Component({
  selector: 'app-validation-certification-inventory',
  standalone: true,
      ...
      <div class="flex items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div class="flex flex-col">
          ...
          <p class="text-xs text-slate-500">
            Formal data reconciliation assertions, row count verification, and discrepancy resolution evidence.
          </p>
        </div>
      ...
      <div class="flex items-center justify-between gap-4 flex-wrap bg-white p-3.5 border border-slate-200 rounded-xl shadow-2xs">
        ...
        <div class="relative flex-1 min-w-[240px] max-w-md">
          ...
          <input
            ...
            placeholder="Search by validation subject, dataset, or ID..."
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="bg-slate-50/80 border-b border-slate-200 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
              <th class="py-3 px-4">Subject &amp; Validation</th>
              ...
              <tr>
                <td colspan="5" class="py-12 text-center text-slate-400">
                  <div class="flex flex-col items-center justify-center gap-2">
                    ...
                    <span class="font-medium">No validation certifications matched your search criteria.</span>
                  </div>
                </td>
              </tr>
            }
...
export class ValidationCertificationInventoryComponent {
  ...
  public filteredList = computed(() => {
    let list = this.rs.allCertifications().filter(c => c.domain === 'VALIDATION');
