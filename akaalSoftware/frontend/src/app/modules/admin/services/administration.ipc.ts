 ...
 * =====================
 * Thin Administration IPC adapter (Pratham Lane P7.D).
 * Wraps the existing generic `IpcService.invoke` with typed request/response
 * methods for the 46 frozen Administration capabilities (34 mandatory backend-dependent,
 * 12 local presentation).
 *
 * All 29 query request_types and 16 command request_types map directly to
 * schemas registered in akaalIPC/protocol/schemas.py and dispatched in
 * PipelineUnifiedCaller / CommandHandlerRegistry / PipelineQueryService.
 *
...
export class AdministrationIpcService {
