    ...
    <svg
      ...
      @switch (name) {
        ...
        @case ('tags') {
          ...
          <path d="M9.586 5.586A2 2 0 0 0 8.172 5H3a1 1 0 0 0-1 1v5.172a2 2 0 0 0 .586 1.414L8.2 18.2a2.4 2.4 0 0 0 3.4 0l3.6-3.6a2.4 2.4 0 0 0 0-3.4Z"/>
        ...
        @case ('folder-tree') {
          <path d="M20 10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-2.5a1 1 0 0 1-.8-.4l-.9-1.2A1 1 0 0 0 15 3h-2a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z"/>
          <path d="M20 21a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-2.9a1 1 0 0 1-.88-.53l-.42-.85a1 1 0 0 0-.9-.62H13a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z"/>
          <path d="M3 5v14a2 2 0 0 0 2 2h7"/>
          <path d="M3 12h5"/>
        }
        @case ('git-fork') {
        ...
        @case ('shuffle') {
          <path d="m18 2 4 4-4 4"/>
          <path d="m14 9 3.5-3.5L22 6"/>
          <path d="M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.1-8.6c.7-1.1 2-1.7 3.3-1.7H22"/>
          <path d="m18 14 4 4-4 4"/>
          <path d="m14 15 3.5 3.5L22 18"/>
        ...
        @case ('puzzle') {
          <path d="M19.439 7.85c0-1.57.876-2.522 1.415-3.109a.5.5 0 0 0-.354-.841H16.5A2.5 2.5 0 0 1 14 1.4V1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v.4A2.5 2.5 0 0 1 7.5 3.9H3.5a.5.5 0 0 0-.354.841c.54.587 1.415 1.54 1.415 3.109 0 1.57-.875 2.522-1.415 3.109A.5.5 0 0 0 3.5 11.8h.4A2.5 2.5 0 0 1 6.4 14.3v.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-.5a2.5 2.5 0 0 1 2.5-2.5h3.6a.5.5 0 0 0 .354-.841c-.54-.587-1.415-1.54-1.415-3.109z"/>
        }
        @case ('terminal') {
          <polyline points="4 17 10 11 4 5"/>
          <line x1="12" x2="20" y1="19" y2="19"/>
