...
function StatusChip({ status }: { status: StatusType }) {
  const configs: Record<StatusType, { label: string; color: string; bg: string; border: string }> = {
    ...
    validated:  { label: 'Validated',  color: '#38BDF8', bg: 'rgba(56,189,248,0.08)',  border: 'rgba(56,189,248,0.2)' },
    approved:   { label: 'Approved',   color: '#22C55E', bg: 'rgba(34,197,94,0.08)',   border: 'rgba(34,197,94,0.2)' },
    ready:      { label: 'Ready',      color: '#A78BFA', bg: 'rgba(167,139,250,0.08)', border: 'rgba(167,139,250,0.2)' },
    running:    { label: 'Running',    color: '#38BDF8', bg: 'rgba(56,189,248,0.08)',  border: 'rgba(56,189,248,0.2)' },
...
function ValidationBadge({ result }: { result: ValidationResult }) {
  const cfg = {
    passed:  { label: 'Passed',  color: '#22C55E', bg: 'rgba(34,197,94,0.08)',  border: 'rgba(34,197,94,0.2)',  icon: '✓' },
    warning: { label: 'Warning', color: '#F59E0B', bg: 'rgba(245,158,11,0.08)', border: 'rgba(245,158,11,0.2)', icon: '!' },
    failed:  { label: 'Failed',  color: '#EF4444', bg: 'rgba(239,68,68,0.08)',  border: 'rgba(239,68,68,0.2)',  icon: '✕' },
  }[result];
  return (
    <span
