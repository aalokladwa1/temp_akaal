...
function StatusChip({ status }: { status: MigStatus }) {
  const configs: Record<MigStatus, { label: string; color: string; bg: string; border: string }> = {
    ...
    paused:    { label: 'Paused',    color: '#FACC15', bg: 'rgba(250,204,21,0.08)', border: 'rgba(250,204,21,0.2)' },
    cancelled: { label: 'Cancelled', color: '#64748B', bg: 'rgba(100,116,139,0.08)', border: 'rgba(100,116,139,0.2)' },
    rollback:  { label: 'Rollback',  color: '#F97316', bg: 'rgba(249,115,22,0.08)', border: 'rgba(249,115,22,0.2)' },
  };
