...
class TestP411UniversalConnectorHostileAudit(unittest.TestCase):
    ...
    def test_AD01_all_19_baseline_systems_verified(self):
        ...
        baseline_19 = [
            ...
            ("mariadb", ConnectorFamily.RELATIONAL_DATABASE, ImplementationState.PARTIAL, SupportState.PARTIAL),
            ("mssql", ConnectorFamily.RELATIONAL_DATABASE, ImplementationState.IMPLEMENTED, SupportState.SUPPORTED),
            ("ibm_db2", ConnectorFamily.RELATIONAL_DATABASE, ImplementationState.PARTIAL, SupportState.PARTIAL),
            ("sqlite", ConnectorFamily.RELATIONAL_DATABASE, ImplementationState.IMPLEMENTED, SupportState.SUPPORTED),
            ("snowflake", ConnectorFamily.CLOUD_DATA_WAREHOUSE, ImplementationState.PARTIAL, SupportState.PARTIAL),
            ("bigquery", ConnectorFamily.CLOUD_DATA_WAREHOUSE, ImplementationState.PARTIAL, SupportState.PARTIAL),
            ("redshift", ConnectorFamily.CLOUD_DATA_WAREHOUSE, ImplementationState.PARTIAL, SupportState.PARTIAL),
