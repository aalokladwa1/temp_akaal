"""akaalPipeline.contracts.crypto
============================
Canonical OS CSPRNG wrapper and crypto random utilities for akaalPipeline.
Strictly relies on secrets / os.urandom. Fail-closed on entropy unavailability.
"""
