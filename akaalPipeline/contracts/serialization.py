...
Complies with AKAAL_CANONICAL_PROFILE_V1 (Unicode NFC normalization + RFC 8785 JCS).
"""
...
def _jcs_key_sort(key: str) -> bytes:
    """Sort keys by UTF-16 code units as required by RFC 8785."""
    return key.encode("utf-16-be")


def _canonical_jcs(obj: Any) -> str:
    """Deterministic RFC 8785 JCS serializer."""
    if obj is None:
        return "null"
...
def canonical_serialize(obj: Any) -> str:
    """Serialize object to deterministic RFC 8785 JCS string after applying NFC normalization."""
