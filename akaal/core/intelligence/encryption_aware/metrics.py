"""
Akaal — Encryption Observability Metrics
========================================
Thread-safe metrics collectors, timing trackers, and counters
for profiling encryption-aware analysis runs and strategy queries.
"""
...
class EncryptionMetricsCollector:
...
class SubsystemTimer:
    ...
    def __init__(self, collector: EncryptionMetricsCollector, metric_name: str) -> None:
