...
def register_canonical_bridge_connectors(registry: Any) -> None:
    ...
    baseline_connectors = [
        ...
        # NoSQL, Graph, Key-Value & Search (Stubs awaiting P4.4)
        LegacyAdapterUniversalBridge("mongodb", SystemType.MONGODB, ConnectorFamily.DOCUMENT_DATABASE, "MongoDB", ConnectorRole.BOTH, supports_cdc=False, supports_cutover=False, supports_failback=False, proof_level=ProofLevel.STATIC_INSPECTION_ONLY, implementation_state=ImplementationState.STUB, support_state=SupportState.UNSUPPORTED, proof_state=ProofState.UNPROVEN),
