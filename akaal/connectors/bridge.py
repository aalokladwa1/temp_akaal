...
def register_canonical_bridge_connectors(registry: Any) -> None:
    ...
    baseline_connectors = [
        ...
        LegacyAdapterUniversalBridge("confluent", SystemType.CONFLUENT, ConnectorFamily.STREAM_EVENT_PLATFORM, "Confluent Platform", ConnectorRole.BOTH, supports_cdc=True, supports_cutover=True, supports_failback=True, proof_level=ProofLevel.UNIT_PROVEN, implementation_state=ImplementationState.IMPLEMENTED, support_state=SupportState.SUPPORTED, proof_state=ProofState.UNIT_PROVEN),
        LegacyAdapterUniversalBridge("msk", SystemType.MSK, ConnectorFamily.STREAM_EVENT_PLATFORM, "Amazon MSK", ConnectorRole.BOTH, supports_cdc=True, supports_cutover=True, supports_failback=True, proof_level=ProofLevel.UNIT_PROVEN, implementation_state=ImplementationState.IMPLEMENTED, support_state=SupportState.SUPPORTED, proof_state=ProofState.UNIT_PROVEN),
