...
import { RBACMatrix } from '@/components/ui/RBACMatrix';
...
function StatusChip({ status, label }: { status: 'active' | 'expired' | 'revoked' | 'enabled' | 'disabled' | 'partial'; label?: string }) {
  const cfg: Record<string, { color: string; bg: string; border: string }> = {
    active:   { color: '#22C55E', bg: 'rgba(34,197,94,0.12)',    border: 'rgba(34,197,94,0.2)' },
    enabled:  { color: '#22C55E', bg: 'rgba(34,197,94,0.12)',    border: 'rgba(34,197,94,0.2)' },
    expired:  { color: '#94A3B8', bg: 'rgba(148,163,184,0.12)', border: 'rgba(148,163,184,0.2)' },
    revoked:  { color: '#EF4444', bg: 'rgba(239,68,68,0.12)',    border: 'rgba(239,68,68,0.2)' },
    disabled: { color: '#94A3B8', bg: 'rgba(148,163,184,0.12)', border: 'rgba(148,163,184,0.2)' },
    partial:  { color: '#F59E0B', bg: 'rgba(245,158,11,0.12)',   border: 'rgba(245,158,11,0.2)' },
  };
