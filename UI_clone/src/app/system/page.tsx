...
const SERVICE_STATUS_META: Record<ServiceStatus, { label: string; color: string; bg: string; border: string; animated: boolean }> = {
  running:    { label: 'Running',    color: '#22C55E', bg: 'rgba(34,197,94,0.12)',    border: 'rgba(34,197,94,0.2)',    animated: false },
  stopped:    { label: 'Stopped',    color: '#64748B', bg: 'rgba(100,116,139,0.12)', border: 'rgba(100,116,139,0.2)', animated: false },
  degraded:   { label: 'Degraded',   color: '#F59E0B', bg: 'rgba(245,158,11,0.12)',  border: 'rgba(245,158,11,0.2)',  animated: true },
  starting:   { label: 'Starting',   color: '#38BDF8', bg: 'rgba(56,189,248,0.12)',  border: 'rgba(56,189,248,0.2)',  animated: true },
  restarting: { label: 'Restarting', color: '#A78BFA', bg: 'rgba(167,139,250,0.12)', border: 'rgba(167,139,250,0.2)', animated: true },
};

const SERVICE_HEALTH_META: Record<ServiceHealth, { label: string; color: string; bg: string; border: string }> = {
  healthy:  { label: 'Healthy',  color: '#22C55E', bg: 'rgba(34,197,94,0.12)',    border: 'rgba(34,197,94,0.2)' },
  warning:  { label: 'Warning',  color: '#F59E0B', bg: 'rgba(245,158,11,0.12)',   border: 'rgba(245,158,11,0.2)' },
  critical: { label: 'Critical', color: '#EF4444', bg: 'rgba(239,68,68,0.12)',    border: 'rgba(239,68,68,0.2)' },
  unknown:  { label: 'Unknown',  color: '#94A3B8', bg: 'rgba(148,163,184,0.12)',  border: 'rgba(148,163,184,0.2)' },
};
...
const LOG_LEVEL_META: Record<LogLevel, { color: string; bg: string }> = {
  ...
  DEBUG:   { color: '#64748B', bg: 'rgba(100,116,139,0.12)' },
...
const CONN_META: Record<IntegrationRecord['connection'], { label: string; color: string; bg: string; border: string }> = {
  connected:    { label: 'Connected',    color: '#22C55E', bg: 'rgba(34,197,94,0.12)',    border: 'rgba(34,197,94,0.2)' },
  disconnected: { label: 'Disconnected', color: '#64748B', bg: 'rgba(100,116,139,0.12)', border: 'rgba(100,116,139,0.2)' },
  error:        { label: 'Error',        color: '#EF4444', bg: 'rgba(239,68,68,0.12)',    border: 'rgba(239,68,68,0.2)' },
};
